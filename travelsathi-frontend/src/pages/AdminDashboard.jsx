...
export default function AdminDashboard() {
    ...
    const fetchData = async () => {
      try {
        const [staysRes, flightsRes, carsRes] = await Promise.all([
          axios.get(`${API_BASE_URL}api/admin/stay`, { headers: { Authorization: `Bearer ${token}` } }),
          axios.get(`${API_BASE_URL}api/admin/flight`, { headers: { Authorization: `Bearer ${token}` } }),
          axios.get(`${API_BASE_URL}api/admin/car`, { headers: { Authorization: `Bearer ${token}` } }),
        ]);
  ...
  const handleAddStay = async () => {
    try {
      await axios.post(`${API_BASE_URL}api/admin/stay`, newStay, {
  ...
  const handleAddFlight = async () => {
    try {
      await axios.post(`${API_BASE_URL}api/admin/flight`, newFlight, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleAddCar = async () => {
    try {
      await axios.post(`${API_BASE_URL}api/admin/car`, newCar, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleUpdateStay = async () => {
    try {
      await axios.put(`${API_BASE_URL}api/admin/stay/${editStay.id}`, editStay, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleUpdateFlight = async () => {
    try {
      await axios.put(`${API_BASE_URL}api/admin/flight/${editFlight.id}`, editFlight, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleUpdateCar = async () => {
    try {
      await axios.put(`${API_BASE_URL}api/admin/car/${editCar.id}`, editCar, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleDeleteStay = async (id) => {
    try {
      await axios.delete(`${API_BASE_URL}api/admin/stay/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleDeleteFlight = async (id) => {
    try {
      await axios.delete(`${API_BASE_URL}api/admin/flight/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleDeleteCar = async (id) => {
    try {
      await axios.delete(`${API_BASE_URL}api/admin/car/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
